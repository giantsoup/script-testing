            ...
            utils : {
                ...
                mqState : {
                    ...
                    checkStateView : function() {
                        ...
                        TD.vals.view  = parseInt( $('.mq-state').css('z-index') );

                        // fallback to desktop if browser doesn't support media queries
                        if ( ! Modernizr.mq( 'only all' ) ) TD.vals.view = 30;
                ...
                setDelay : function() {
                    ...
                    TD.vals.$window.on( 'scroll touchmove', function() { scrolled = true; });
                    // delay checking of window resize
                    TD.vals.$window.on( 'resize', function() { resized = true; });
                    ...
                    setInterval( function() {
                        ...
                        if ( resized ) {
                            ...
                            TD.utils.mqState.checkStateView();
                        }
